	...
	const options = [
		{
			id: "premium",
			price: "$29.99 / month",
			description: ["Video upload for replay", "Sports advanced analysis", "Unlimited AI editing usage", "Team colloration"],
		},
		{ id: "pro", price: "$19.99 / month", description: ["Video upload for replay", "Sports performance analysis", "Unlimited AI editing usage"] },
		{
			id: "basic",
			price: "$9.99 / month",
			description: ["Video upload for replay", "Limited sports performance analysis", "Limited AI editing usage"],
		},
		{
			id: "free",
			price: "$0.00 / month",
				...
				<TableBody>
					{options.map(option => (
						<TableRow key={option.id}>
							<TableCell>
								<Radio checked={selectedOption === option.id} onChange={handleChange} value={option.id} name="plan-radio-button" />
